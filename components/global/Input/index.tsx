        ...
        <div>
            ...
            <div className="relative">
                <input
                    ...
                    id={name}
                    required={required}
                    className="w-full px-4 h-14 mt-1 border border-stroke rounded-[5px] focus:outline-none focus:ring-[1px] focus:ring-blueStroke focus:border-none"
                />
                {isPasswordType && (
                    <button
                        type="button"
                        onClick={handleTogglePassword}
                        className="absolute inset-y-0 right-0 flex items-center pr-2 text-secondary cursor-pointer"
                    >
